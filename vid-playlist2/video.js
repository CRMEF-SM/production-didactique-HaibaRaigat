window.addEventListener("DOMContentLoaded", () => {
  ...
  let playlist = [
    {name: "Les Logiciels partie 1", src: "/block_videos/1.mp4"},
    {name: "Les Logiciels partie 2", src: "/block_videos/2.mp4"},
    {name: "Les Logiciels partie 3", src: "/block_videos/3.mp4"}
  ];
